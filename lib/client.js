...
setTimeout(() => {
	...
	try{
		...
		console.log('Could not connect with Mongodb so plz change mangodb from vars and put your own if you dont have plz conntact me at whatsapp.\nPlease visit https://github.com/itxxwasi/wasi-tech')
	}
    }
    main()
    //========================================================================================================================================
 ...
 Void.ev.on('group-participants.update', async(anu) => {
        ...
        Void.ev.on('connection.update', async(update) => {
                ...
                if (connection === 'open') {
                    ...
                    console.log("⬇️  Installing External Plugins of wasi-tech...");
