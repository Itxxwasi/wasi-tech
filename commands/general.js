...
cmd({
    ...
    async(Void, citel) => {
        ...
        let ter = `
🔰 *${tlang().title}* 🔰
*🌟Description:* A WhatsApp bot with rich features, build in Java to make your WhatsApp enjoyable.
...
str+=`1. KING-MD\n2. NEZUKO\n3. ANIME\n\n these are the themes of KING Userbot.\_Reply ${prefix}setvar THEME:ANIME`
